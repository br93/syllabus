...
var RegisterCourseRoutes = func(router *gin.Engine) {
	...
	router.PUT("/api/v1/config/courses/:course_id/prequisites/", controllers.AddPreRequisite)
	router.GET("/api/v1/config/courses/:course_id/prequisites/", controllers.GetCoursePreRequisites)
