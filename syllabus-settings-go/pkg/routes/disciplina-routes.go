...
var RegisterDisciplinaRoutes = func(router *gin.Engine) {
	...
	router.GET("/api/v1/disciplinas/:disciplina_id/pre/", controllers.GetDisciplinaPreRequisitos)
	router.PUT("/api/v1/disciplinas/:disciplina_id/equivalentes/", controllers.AddEquivalente)
	router.GET("/api/v1/disciplinas/:disciplina_id/equivalentes/", controllers.GetDisciplinaEquivalentes)
	router.GET("/api/v1/disciplinas/:disciplina_id/turmas/", controllers.GetTurmasByDisciplina)
}
